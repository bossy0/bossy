from multiprocessing import Process, Manager, Pool                 import urlparse, ssl
...
class Striker(Process):
    ...
    def getUserAgent(self):
        ...
        if 'browser_info' in platform and platform['browser_info']:            browser = platform['browser_info']
