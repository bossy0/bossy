...
def proxylist(): # funzione per la creazione della proxylist
	...
	print (''' \033[93m [+] Current IPs in proxylist: %s\033[0m''') % (len(open("proxy.txt").readlines()))) # per vedere quante lines (e quindi quanti proxy) ci sono nel file
	print ("\nProxylist Updated!\n")
...
def main(): # funzione effettiva del programma.
	try:
		...
		print (''' \033[93m Downloading From Free-Proxy-List İn Progress . . .\033[0m''')
